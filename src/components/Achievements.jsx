...
const AnimatedDigit = ({ children, delay, triggerRoll }) => {
  return (
    <span className="relative inline-block overflow-hidden align-bottom">
      <span
        className={`relative block transition-transform duration-700 ease-[cubic-bezier(0.65,0,0.35,1)] ${
...
function Achievements() {
  ...
  // Base card class — removed forced `dark:text-black` so dark mode inherits proper contrast
  const cardBaseClass =
      ...
      <div className="flex flex-col gap-6 md:gap-0">
        ...
        <div
          ...
          className={`${cardBaseClass}
            bg-[#E1EAEA] dark:bg-[#16181A]
            text-black dark:text-[#E1EAEA]
            self-start
            md:hover:bg-[#df4818] md:hover:text-[#e0eeee]
            dark:md:hover:bg-[#df4818] dark:md:hover:text-[#e0eeee]`}
        >
          ...
          <div className="uppercase text-xl md:text-3xl font-semibold text-right w-fit ml-auto mt-10 md:mt-19">
        ...
        <div
          ...
          className={`${cardBaseClass}
            bg-[#E1EAEA] dark:bg-[#16181A]
            text-black dark:text-[#E1EAEA]
            self-start md:self-end md:-mt-45
            md:hover:bg-[#4c4e51] md:hover:text-[#dde5de]
            dark:md:hover:bg-[#4c4e51] dark:md:hover:text-[#dde5de]`}
        >
          <div className="text-7xl md:text-9xl tracking-[-3px] flex">
        ...
        <div
          ...
          className={`${cardBaseClass}
            ...
            text-black dark:text-[#E1EAEA]
            self-start md:-mt-45
            md:hover:bg-[#a0c8b8] md:hover:text-[#e0eeee]
            dark:md:hover:bg-[#a0c8b8] dark:md:hover:text-[#e0eeee]`}
        >
          <div className="text-7xl md:text-9xl tracking-[-3px] flex">
        ...
        <div
          ...
          className={`${cardBaseClass}
            ...
            text-black dark:text-[#E1EAEA]
            self-start md:self-end md:-mt-45
            md:hover:bg-[#dbcc3d] md:hover:text-[#1a1a1a]
            dark:md:hover:bg-[#dbcc3d] dark:md:hover:text-[#1a1a1a]`}
        >
          <div className="text-7xl md:text-9xl tracking-[-3px] flex">
