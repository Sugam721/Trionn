  ...
  return (
    ...
    >
      ...
      <div className="dribble-center -z-10  flex items-center justify-center flex-col absolute px-6">
        <img src="/dribbble.1a51ca99.webp" className="w-30 md:w-50" alt="" />
        ...
        <button className="text-lg md:text-xl mt-6 md:mt-10 border border-[#BAEFEF] dark:border-white px-8 py-3 md:py-4 rounded-full">
          View Dribble
        </button>
      </div>
    </div>
