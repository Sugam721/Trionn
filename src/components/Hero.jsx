...
function Hero() {
  ...
  return (
    <div className="mx-auto  relative w-full flex flex-col items-center  md:mt-50 sm:px-6">
      <div className="h-screen relative sm:h-auto">
          ...
          <p className="flex flex-col items-center mt-6 md:mt-10 uppercase text-center text-xs md:text-sm max-w-xs md:max-w-none">
            ...
            >
              <img
                ...
                alt=""
                className="mt-5 size-5 md:size-6.25 cursor-pointer"
              />
            </button>
          </p>
        </div>
        ...
        >
          <video
            ...
            loop
            muted
            className="w-30 md:w-45.25 rounded-full pointer-events-none"
          ></video>
        </div>
        <div className="buttons flex md:absolute sm:top-[75%] justify-between gap-9  relative  w-full sm:gap-4 mt-0 sm:px-6 md:px-0">
          <button className="text-xs  sm:text-lg md:text-xl border border-[#B7EAEA] dark:border-white px-8 py-3 md:py-4 rounded-full ">
            Explore work
          </button>
          <button className="text-xs sm:text-lg md:text-xl border border-[#B7EAEA] dark:border-white px-8 py-3 md:py-4 rounded-full ">
            Get in touch
      ...
      >
        <video
          src="https://res.cloudinary.com/dgfp5n7bn/video/upload/v1779809352/intro-video_p1axkd.mp4"
          autoPlay
          loop
          muted
