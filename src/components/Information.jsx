  ...
  const clients = [
    {
      ...
      img: "https://res.cloudinary.com/dgfp5n7bn/image/upload/v1779820778/malte-kramer_vte5hv.webp",
    },
    {
      name: "Doug Petrie",
      role: "Founder and CEO of Fast Resume",
      img: "https://res.cloudinary.com/dgfp5n7bn/image/upload/v1779820775/doug-petrie_it3hnn.webp",
    },
    {
      name: "Zoltan Csonka",
      role: "Founder and CEO of Ventigence",
      img: "https://res.cloudinary.com/dgfp5n7bn/image/upload/v1779820780/zoltan-csonka_q25u8v.webp",
    },
  ];
  ...
  return (
    <div className="px-6 md:px-0 ">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end mt-20 gap-10">
        <h3
          id="partner-love"
          className="text-6xl md:text-[135px] font-semibold leading-tight md:leading-25 tracking-tight md:tracking-[-8px] scale-y-110 md:scale-y-120 origin-bottom"
        >
          <div className="">
      ...
      >
        <div className="carousel-track flex gap-4 w-max">
          {allClients.map((client, index) => (
            <div
              key={index}
              className="group carousel-item h-100 md:h-150 w-75 md:w-150 flex items-center justify-center hover:bg-[#e1eaea] dark:hover:bg-[#16181a] border border-black dark:border-white hover:border-none rounded-[30px] transition-colors duration-300"
            >
              <div className="flex flex-col items-center px-4 text-center">
                <div className="overflow-hidden rounded-full h-32 w-32 md:h-47.5 md:w-47.5">
                  <img
                    src={client.img}
               ...
               <p className="text-xl md:text-3xl mt-6 md:mt-8 text-black dark:text-white group-hover:text-black dark:group-hover:text-white transition-colors duration-300">
                  {client.name}
                </p>
               <p className="text-sm md:text-lg mt-1 md:mt-2 opacity-70 text-black dark:text-white group-hover:text-black dark:group-hover:text-white transition-colors duration-300">
                  {client.role}
                </p>
