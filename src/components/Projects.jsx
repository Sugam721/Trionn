  ...
  return (
    <div id="works" className="px-6 md:px-0 ">
      ...
      >
        ...
        <div>
          <button className="text-lg md:text-xl border border-[#B7EAEA] dark:border-white px-8 py-3 md:py-4 rounded-full">
            Explore work
          </button>
        </div>
      </div>
        ...
        <div id="projects" className="flex flex-col gap-20">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-10 md:gap-20">
            <div className="project-info1 w-full md:w-auto order-2 md:order-1">
              ...
              <button className="hidden md:block text-lg border border-[#B7EAEA] mt-6 md:mt-10 dark:border-white px-8 py-3 md:py-4 rounded-full">
                View project
              </button>
            </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-10 md:gap-20">
            ...
            <div className="w-full md:w-auto order-1 md:order-2">
              <img
                id="img3"
                src="https://res.cloudinary.com/dgfp5n7bn/image/upload/v1779820780/technis-main-landscape_alqzbo.webp"
                className="work-img w-full aspect-video object-cover rounded-[20px] md:rounded-[30px]"
                alt=""
              />
            </div>
